...
if uploaded_files:
    ...
    if verif_fck_df is not None and not verif_fck_df.empty:
        ...
        _apply_status_colors(tv, rows_v[1:], status_col_indexes=3)  # cor na coluna Status
    ...
    if cond_df is not None and not cond_df.empty:
        ...
        _apply_status_colors(tc, rows_c[1:], status_col_indexes=4)  # cor na coluna Status
    ...
    if pareamento_df is not None and not pareamento_df.empty:
        ...
        _apply_status_colors(tp, rows_p, status_col_indexes=5)  # cor na coluna Status
